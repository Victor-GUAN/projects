...
for i in range(batch_size):
	D = {"level": 0, "name": Nodes[i].name, "img": Nodes[i].source, "coord": {"tSNE": [Nodes[i].x, Nodes[i].y]}}
...
with open(r'E:/Buggy_TSNE_graph.json_version_0.9_iter_html.json', 'w') as outfile:
