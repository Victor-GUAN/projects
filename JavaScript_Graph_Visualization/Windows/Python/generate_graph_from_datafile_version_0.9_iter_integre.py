...
def main():
    ...
    parser.add_option("--input_list", dest="input_list", help="the initial image id data file", default="E:/Buggy/buggy_small_icons.lst", metavar="FILE")
    parser.add_option("--directory", dest="directory", help="the directory path for the document of images (without '/' at the end)", default="E:/Graph Visualization Tool/data", metavar="FILE")
    ...
    parser.add_option("--input_path", dest="input_path", help="the initial tsv data file", default="E:/DerivedObjects_pixels_grey.tsv", metavar="FILE")
    parser.add_option("--output_path", dest="output_path", help="the output path for the final json file", default="E:\Dassault\\3.29\Json\Buggy_TSNE_30_100_3000_0_25_pixel_3.22.json", metavar="FILE")
