...
public class PlanTest {
	...
	@Test
	public void testMost_used_station() throws Exception{
        ...
        assertEquals(s_4_plus, plan.most_used_station().iterator().next());
	}

	@Test
	public void testLeast_occupied_station_mech() throws Exception{
		Card card_vmax = new Card_Vmax();
		Card card_vlibre = new Card_Vlibre();
        ...
        assertEquals(s_4_plus, plan.least_occupied_station_mech(0.5*1000, 1.5*1000).iterator().next());
	}

	@Test
	public void testLeast_occupied_station_elec() throws Exception{
		Card card_vmax = new Card_Vmax();
		Card card_vlibre = new Card_Vlibre();
        ...
        assertEquals(s_4_plus, plan.least_occupied_station_elec(0.5*1000, 1.5*1000).iterator().next());
	}

	@Test
	public void testFind_routine_shortest() throws Exception{		
		Station s_1_plus = new Station_Plus(1,20,0,5,10);
		for(Slot s: s_1_plus.getPlaces_mech().keySet())
		{for(int i=11;i<=13;i++){if(s.getId()+10==i){s_1_plus.getPlaces_mech().put(s, new Bicycle_Mech(i));}}}
		for(Slot s: s_1_plus.getPlaces_elec().keySet())
		...
		assertEquals(s_4_plus,plan.find_routine_shortest(new double[]{-1,-1},new double[]{30,30}).getSource());
		assertEquals(s_3_standard,plan.find_routine_shortest(new double[]{-1,-1},new double[]{30,30}).getDestination());
	}

	@Test
	public void testFind_routine_fastest() throws Exception{
		Station s_1_plus = new Station_Plus(1,20,0,5,10);
		for(Slot s: s_1_plus.getPlaces_mech().keySet())
		{for(int i=11;i<=13;i++){if(s.getId()+10==i){s_1_plus.getPlaces_mech().put(s, new Bicycle_Mech(i));}}}
		for(Slot s: s_1_plus.getPlaces_elec().keySet())
	...
	@Test
	public void testFind_routine_avoid_plus() throws Exception{
		Station s_1_plus = new Station_Plus(1,20,0,5,10);
		for(Slot s: s_1_plus.getPlaces_mech().keySet())
		{for(int i=11;i<=13;i++){if(s.getId()+10==i){s_1_plus.getPlaces_mech().put(s, new Bicycle_Mech(i));}}}
		for(Slot s: s_1_plus.getPlaces_elec().keySet())
	...
	@Test
	public void testFind_routine_prefer_plus() throws Exception{
		Station s_1_plus = new Station_Plus(1,20,0,5,10);
		for(Slot s: s_1_plus.getPlaces_mech().keySet())
		{for(int i=11;i<=13;i++){if(s.getId()+10==i){s_1_plus.getPlaces_mech().put(s, new Bicycle_Mech(i));}}}
		for(Slot s: s_1_plus.getPlaces_elec().keySet())
	...
	@Test
	public void testFind_routine_uniform() throws Exception{
		Station s_1_plus = new Station_Plus(1,20,0,5,10);
		for(Slot s: s_1_plus.getPlaces_mech().keySet())
		{for(int i=11;i<=13;i++){if(s.getId()+10==i){s_1_plus.getPlaces_mech().put(s, new Bicycle_Mech(i));}}}
		for(Slot s: s_1_plus.getPlaces_elec().keySet())
