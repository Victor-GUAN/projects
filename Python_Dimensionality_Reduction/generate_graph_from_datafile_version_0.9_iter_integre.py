...
def main():
    ...
    parser.add_option("--output_path", dest="output_path", help="the output path for the final json file", default="E:/Dassault/json/Buggy_TSNE_graph.json_version_0.9_iter.json", metavar="FILE")
