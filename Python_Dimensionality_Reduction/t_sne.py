...
class TSNE(BaseEstimator):
    ...
    def _tsne(self, P, degrees_of_freedom, n_samples, random_state,
        ...
        opt_args['it'] = it + 1
        params, error, it, set_3_X = _gradient_descent(obj_func, params, **opt_args)
        ...
        B=[[]]
        B[0] = set_2_X[0].reshape(n_samples, self.n_components)
        #set_X_embedded.extend(B)

        #for i in range(len(set_3_X)):
        C=[[]]
        C[0] = set_3_X[0].reshape(n_samples, self.n_components)
